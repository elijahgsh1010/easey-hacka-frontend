...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      "Super EASEY Reactive Resume is a free and open source resume builder that's built to make the mundane tasks of creating, updating and sharing your resume as easy as 1, 2, 3.",
    )
